...
export async function OperationsDuJour({
  agencyId,
  date,
  locale = "fr",
}: {
              ...
              <>
                ...
                <div className="space-y-2">
                  ...
                  {upcomingDays.slice(0, 3).map((day) => (
                    <Link
                      key={day.dateISO}
                      href={withLocalePath(locale, `/bookings?date=${day.dateISO}`)}
            ...
            {operations.map((op, index) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Client + vehicle info */}
                  <Link
                    href={withLocalePath(locale, `/bookings/${booking.id}`)}
                    ...
                    <Button variant="outline" size="sm" className="gap-1.5 h-9" asChild>
                      {isSortie ? (
                        ...
                        <Link
                          href={withLocalePath(
                            locale,
                            `/damage-reports/${booking.damageReports[0].id}`
                          )}
                          title="Inspection"
                        >
                        ...
                        <Link
                          href={withLocalePath(
                            locale,
                            `/damage-reports/new?bookingId=${booking.id}`
                          )}
