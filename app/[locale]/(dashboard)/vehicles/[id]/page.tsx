...
export default async function VehicleProfilePage({
  ...
  return (
    <div className="mx-auto max-w-[1400px] space-y-8 pb-12">
      ...
      />
      <VehicleActionRequiredStrip workspace={profile.workspace} locale={locale} />
      ...
      {currentTab === "reservations" ? (
        <VehicleReservationsPanel vehicleId={profile.vehicle.id} reservations={profile.reservations} locale={locale} />
      ) : null}
      {currentTab === "tracking" ? (
        <VehicleTrackingTab
          data={profile}
