...
export default async function CaissePage({ params, searchParams }: CaissePageProps) {
  ...
  const monthParam = parseMonthParam(paramsSp.month);
  ...
  if (isMonthView) {
    ...
    const requested = parseDateParam(paramsSp.date);
