...
export function AgencyStorefrontPage({ settings, vehicles }: AgencyStorefrontPageProps) {
  ...
  return (
    <main className="min-h-screen bg-[hsl(var(--public-surface))] text-[hsl(var(--public-ink))]">
      ...
      <section className="relative overflow-hidden bg-[linear-gradient(180deg,rgba(232,243,255,0.92)_0%,rgba(238,247,255,0.78)_18%,rgba(246,250,255,0.42)_34%,#ffffff_52%,#ffffff_100%)]">
        <section aria-labelledby="storefront-hero-title" className="relative">
        ...
        <section id="how-it-works" className="relative py-16 lg:py-20">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-5xl rounded-[2rem] border border-white/60 bg-white/28 px-6 py-10 shadow-[0_14px_36px_rgba(33,150,243,0.04)] backdrop-blur-[1.5px] sm:px-8 lg:px-10 lg:py-12">
              ...
              <div className="relative mx-auto mt-10 grid max-w-5xl gap-8 md:grid-cols-3 md:gap-10">
            ...
            <div id="fleet" className="mt-14 lg:mt-16">
            ...
            {vehicles.length === 0 ? (
              <div className="mt-10 rounded-[2rem] border border-white/80 bg-white/88 p-10 shadow-[0_26px_60px_rgba(25,28,30,0.06)] ring-1 ring-[hsl(var(--public-border))]/60 backdrop-blur-sm">
