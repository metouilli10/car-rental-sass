...
const defaultTiers = [
  ...
  },
  {
    ...
    description: "Best for teams scaling paid acquisition",
    icon: (
      <div className="relative">
        <Sparkles className="w-7 h-7 relative z-10 text-indigo-500" />
      </div>
    ),
    features: [
      {
        name: "Attribution AI",
        description: "Conversion path recommendations in real-time",
        included: true,
      },
      {
        name: "Unlimited Sources",
        description: "Track every paid and organic touchpoint",
        included: true,
      },
      {
        name: "Conversion Sync",
        description: "One-click sync to ad platforms",
        included: true,
      },
      {
