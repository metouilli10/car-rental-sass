      ...
      <div className="mx-auto max-w-2xl px-6 lg:max-w-5xl">
        <div className="mb-10 max-w-2xl text-left">
          ...
          <h2 className="mt-4 text-3xl font-semibold tracking-[-0.04em] text-slate-950 md:text-4xl">
            The operational layer behind your rental desk.
          </h2>
        </div>
        ...
        <div className="mx-auto grid gap-4 lg:grid-cols-2">
          <FeatureCard>
            <CardHeader className="pb-3">
              <CardHeading
                ...
                description="Track every vehicle, location, and status change in one place."
              />
            </CardHeader>
            ...
            <div className="relative mb-6 border-t border-dashed sm:mb-0">
              ...
              <div className="aspect-[76/59] p-1 px-6">
                <DualModeImage
                  darkSrc="https://images.unsplash.com/photo-1492144534655-ae79c964c9d7?auto=format&fit=crop&w=1207&q=80"
                  lightSrc="https://images.unsplash.com/photo-1492144534655-ae79c964c9d7?auto=format&fit=crop&w=1207&q=80"
                  alt="vehicle fleet overview"
                  width={1207}
                  height={929}
                />
              </div>
          ...
          <FeatureCard>
            <CardHeader className="pb-3">
              <CardHeading
                ...
                description="Coordinate departures, returns, and availability without overlap."
              />
            </CardHeader>
            ...
            <CardContent>
              <div className="relative mb-6 sm:mb-0">
                ...
                <div className="aspect-[76/59] overflow-hidden border border-[#e6e0d7] bg-white">
                  <DualModeImage
                    darkSrc="/screenshots/locaryxx.png"
                    lightSrc="/screenshots/locaryxx.png"
                    alt="calendar and scheduling illustration"
                    width={1207}
                    height={929}
          ...
          <FeatureCard className="p-6 lg:col-span-2">
            <p className="mx-auto my-6 max-w-md text-balance text-center text-2xl font-semibold text-slate-950">
              Smart workflows for reservations, maintenance, payments, and daily
              handoffs.
            </p>
...
const FeatureCard = ({ children, className }: FeatureCardProps) => (
  <Card className={cn('group relative rounded-none border-[#e8e2d9] bg-white shadow-zinc-950/5', className)}>
    <CardDecorator />
    {children}
  </Card>
)
...
const CardHeading = ({ icon: Icon, title, description }: CardHeadingProps) => (
  <div className="p-6">
    ...
    <p className="mt-8 text-2xl font-semibold tracking-[-0.03em] text-slate-950">
      {description}
    </p>
  </div>
)
