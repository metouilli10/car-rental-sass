...
export function TopNavBar({ userName, userEmail, agencyName }: TopNavBarProps) {
  ...
  return (
    <header className="h-16 bg-white border-b border-border/40 flex items-center justify-between px-6 shrink-0 z-30 relative">
      {/* Left — Search */}
      <div className="relative w-80 lg:w-96">
        ...
        <input
          ...
          className="w-full h-10 pl-10 pr-4 rounded-xl bg-[#F3F4F6] text-sm text-foreground placeholder:text-muted-foreground/50 outline-none transition-all duration-200 focus:bg-white focus:ring-2 focus:ring-primary/20 focus:shadow-sm"
        />
      </div>
      ...
      <div className="flex items-center gap-3">
        ...
        <div ref={notifRef} className="relative">
          <button
            ...
            className="relative h-10 w-10 flex items-center justify-center rounded-xl bg-[#F3F4F6] text-muted-foreground hover:bg-gray-200/70 hover:text-foreground hover:scale-105 active:scale-100 transition-all duration-200"
          >
          ...
          {notifOpen && (
            <div className="absolute right-0 top-full mt-2 w-96 bg-white rounded-2xl shadow-card-lg border border-border/30 overflow-hidden animate-scale-in origin-top-right">
        ...
        <div ref={profileRef} className="relative">
          <button
            ...
            className="flex items-center gap-3 rounded-xl px-2.5 py-1.5 hover:bg-muted/50 transition-all duration-200"
          >
            <div className="h-9 w-9 rounded-full bg-gradient-to-br from-primary to-primary/80 flex items-center justify-center text-white text-xs font-semibold shadow-sm">
              {initials}
            </div>
